/*
 * Phase Vocoder example Female Voice Dry Mix.
 */
#include <Audio.h>
#include <Wire.h>
#include <SPI.h>
...
AudioConnection patch2    (vocoder, 0, mix, 1);
AudioConnection patch3    (mix,     0, usb, 0);
AudioConnection patch_usbl(mix,     0, usb, 0);
AudioConnection patch_usbr(mix,     0, usb, 1);
AudioConnection patch_dac (mix,     0, dac, 0);
